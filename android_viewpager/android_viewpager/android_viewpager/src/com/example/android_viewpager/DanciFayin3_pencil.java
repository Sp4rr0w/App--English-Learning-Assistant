...
import android.widget.Toast;
	...
	public class DanciFayin3_pencil extends Activity{
		...
		private HashMap<Integer, Integer> soundmap = new HashMap<Integer, Integer>();	//创建一个HashMap对象
			...
			protected void onCreate(Bundle savedInstanceState) {
				...
				setContentView(R.layout.danc_pencil);
				...
				soundmap.put(1, soundpool.load(this, R.raw.pencil, 1));
		...
		soundpool.play(soundmap.get(4), 1, 1, 0, 0, 1);	//播放指定的音频
			...
			public boolean onKeyDown(int keyCode, KeyEvent event) {
				...
				if (keyCode == KeyEvent.KEYCODE_BACK) {
					...
					Intent intent=new Intent(DanciFayin3_pencil.this,DanciList2.class);
